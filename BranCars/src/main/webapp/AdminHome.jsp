  ...
  <header>
    ...
    <nav>
      <ul class="menu">
        ...
        <li><a href="Addcar.html">add</a></li>
        <li><a href="searchcar.html" class="effect-3">searchcar</a></li>
       
         <li><a href="viewallcars.html">viewall</a></li>
        <li><a href="price-list.html">update</a></li>
        <li><a href="locations.html">delete</a></li>
      </ul>
      <div class="clear">welcome to admin</div>
    </nav>
  </header>
  <section id="content">
    <div class="sub-page">
